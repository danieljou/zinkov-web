            ...
            <div class="container items-center px-4 py-8 m-auto mt-5">
                <div class="flex flex-wrap pb-3 mx-4 md:mx-24 lg:mx-0">
                    ...
                    <div class="w-full p-2 lg:w-1/4 md:w-1/2">
                        <div
                            class="flex flex-col px-6 py-10 overflow-hidden bg-white hover:bg-gradient-to-br hover:from-purple-400 hover:via-blue-400 hover:to-blue-500 rounded-xl shadow-lg duration-1000 hover:shadow-2xl group ">
                    ...
                    <div class="w-full p-2 lg:w-1/4 md:w-1/2">
                        <div
                            ...
                            <h1 class="text-3xl sm:text-4xl xl:text-5xl font-bold text-gray-700 mt-12 group-hover:text-gray-50">00:03:20%
                            </h1>
                            <div class="flex flex-row justify-between group-hover:text-gray-200">
